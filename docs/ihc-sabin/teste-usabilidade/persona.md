# Persona do Participante — Teste de Usabilidade

> **Objetivo deste documento:** descrever o perfil-alvo de participante para as sessões de Think Aloud e fornecer um checklist objetivo para a equipe decidir, no recrutamento, se um candidato se encaixa nessa persona.
...
- Agendar exames para si ou para familiares sem precisar telefonar.
- Conferir instruções de preparo (jejum, restrições) antes de ir ao laboratório.
- Acessar resultados de exames online assim que ficam prontos.
- Confirmar se o convênio/plano de saúde é aceito antes de se deslocar.

**Frustrações esperadas:**

- Pouca paciência para fluxos longos ou que exigem cadastro complexo.
- Insegurança ao preencher dados sensíveis (CPF, dados de saúde) sem orientação clara.
- Abandona a tarefa e liga para a central se travar por mais de 1–2 minutos.
...
Use este checklist durante a conversa/formulário de triagem para decidir se o candidato **se enquadra na persona buscada**. Cada item deve ser confirmado com o candidato antes de agendar a sessão.
